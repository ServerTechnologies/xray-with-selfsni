...
## Использование с панелью 3x-ui: решение конфликта SSL

Если вы планируете использовать панель **3x-ui** вместо голого ядра, встроенный 
SSL в 3x-ui конфликтует с nginx на порту 80. Решение — получить сертификат через 
**certbot вручную**, до настройки панели.

Подробная пошаговая инструкция со скриптом автоматизации (nginx + certbot + 3x-ui 
одной командой): [opndoor.io](https://opndoor.io/ru/guides/svoj-vpn-server-za-15-minut-vless-tls-svoj-domen)
